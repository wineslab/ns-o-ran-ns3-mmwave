...
class MavenirHeuristic : public Object{
   ...
   * @param ltedev pointer to the LteEnbNetDevice used to obtain the m_rrc to change the state of the cells
   ...
   */
  std::vector<std::vector<Ptr<MmWaveEnbNetDevice>>> ReadClusters(std::string clustersString, uint8_t nMmWaveEnbNodes, NetDeviceContainer mmWaveEnbDevs);
